...
from dataset.dataset_MSCMR import  RandomGenerator,MSCMRDataSets
...
parser.add_argument('--exp', type=str,
                    default='MSCMR/InterFA_SA_Two', help='experiment_name')
...
parser.add_argument('--max_iterations', type=int,
                    default=6900, help='maximum epoch number to train')
...
parser.add_argument('--PL_path', type=str,
                    default='ACDC_training_conf_iteration3', help='Name of Experiment')
...
def train(args, snapshot_path, savepath):
    ...
    db_val = MSCMRDataSets(base_dir=args.root_path, fold=args.fold,transform=transforms.Compose([

...
from dataset.dataset_ACDC import BaseDataSets_SAM,RandomGenerator_SAM
...
def get_args_parser():
    ...
    parser.add_argument('--max_epochs', type=int, default=15, help='total epoch')
...
def main(opts, snapshot_path, savepath):
    ...
    # save_best_path = '/home/cj/code/model_New/SAM_FineTune/iteration1_vith/MSCMR/sam_best_decoder.pth'
    ...
    diceloss = SAM_loss.pDLoss(4,ignore_index=4)
    ce_loss = CrossEntropyLoss(ignore_index=4)

    es = SAM_trainer.EarlyStopping(patience=50, delta=0, mode='min', verbose=True)
